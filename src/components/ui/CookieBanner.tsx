...
export function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-[100] p-4 md:p-6 animate-in slide-in-from-bottom duration-500 flex justify-center">
      <div className="w-full max-w-5xl backdrop-blur-2xl bg-white/70 dark:bg-[#050505]/80 border border-black/10 dark:border-white/10 rounded-2xl p-6 shadow-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
