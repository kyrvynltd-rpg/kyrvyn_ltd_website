  ...
  return (
    <div className="py-12 max-w-3xl mx-auto">
      ...
      <p className="text-cool-grey dark:text-gray-400 mb-12 border-b border-black/10 dark:border-white/10 pb-8 text-sm">
        Effective Date: October 2026. This document outlines the institutional compliance architectures deployed by Decima Minus Ltd operating under the UK General Data Protection Regulation (UK GDPR).
      </p>
      ...
      <section className="backdrop-blur-md bg-white/70 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-3xl p-8 shadow-lg mb-8">
        ...
        <p className="text-sm leading-relaxed text-black/50 dark:text-white/50 italic font-medium">
          Decima Minus Ltd stores corporate contact data in secure, access-controlled UK systems and uses encryption in transit. Records are retained only as long as needed to respond to requests and meet legal obligations.
        </p>
      </section>
      ...
      <section className="backdrop-blur-md bg-white/70 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-3xl p-8 shadow-lg">
        ...
        <p className="text-sm leading-relaxed mb-4 text-cool-grey dark:text-gray-300">
          Decima Minus Ltd maintains strict regulatory compliance with the Financial Conduct Authority (FCA) SYSC framework regarding operational resilience and data risk mitigation in distributed ledger ecosystems.
        </p>
        <p className="text-sm leading-relaxed text-black/50 dark:text-white/50 italic font-medium">
          We maintain incident response procedures, review third-party subprocessors, and handle Subject Access Requests via decimaminus@gmail.com.
        </p>
      </section>
    </div>
  );
