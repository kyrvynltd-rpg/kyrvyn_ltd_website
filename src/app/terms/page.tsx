      ...
      <GlassCard className="p-8 shadow-xl">
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <p className="text-slate-900 dark:text-slate-400 leading-relaxed mb-6">
            Decima Minus Ltd provides technology and protocol infrastructure only and does not act as a broker-dealer, trading venue, virtual asset service provider, or financial advisor.
          </p>
