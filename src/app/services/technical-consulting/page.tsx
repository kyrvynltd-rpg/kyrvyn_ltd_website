        ...
        >
          <GlassCard className="p-8 relative md:p-16">
            ...
            <p className="text-xl md:text-2xl text-slate-700 dark:text-slate-300 mx-auto font-medium mb-10 max-w-2xl">
              ...
              start shipping. We help you build the right foundation for your digital products.
            </p>
            <motion.div
      ...
      <section className="w-full">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-700 dark:text-slate-300 max-w-2xl mx-auto">
            Whether you are launching a new product or scaling an existing one, making the wrong
            technical choices can cost you months of development time and thousands in technical
            debt. Our consulting services provide clarity.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <GlassCard className="p-8 group hover:-translate-y-1 transition-transform duration-300 flex flex-col h-full">
            ...
            <p className="text-slate-700 dark:text-slate-300 mb-6 flex-grow">
              We design scalable, secure, and future-proof architectures tailored to your specific
              business requirements. We ensure your system can handle growth without catastrophic
              bottlenecks.
            </p>
            <ul className="space-y-3 text-slate-600 dark:text-slate-400 mb-8">
              <li className="flex items-start gap-3">
                <CheckCircle2 size={20} className="text-indigo-500 flex-shrink-0 mt-0.5" />{" "}
                <span>Microservices vs Monolith evaluation</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={20} className="text-indigo-500 flex-shrink-0 mt-0.5" />{" "}
                <span>Database and infrastructure planning</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={20} className="text-indigo-500 flex-shrink-0 mt-0.5" />{" "}
                <span>Security and compliance blueprinting</span>
              </li>
            </ul>
            <div className="mt-auto pt-6 border-t border-slate-200 dark:border-white/10">
              ...
              <div className="text-lg font-bold text-slate-900 dark:text-white">
                Custom quoting (Typically from £1,500)
              </div>
            </div>
          </GlassCard>
          ...
          <GlassCard className="p-8 group hover:-translate-y-1 transition-transform duration-300 flex flex-col h-full">
            ...
            <p className="text-slate-700 dark:text-slate-300 mb-6 flex-grow">
              Don&apos;t chase trends. We help you choose the right tools, frameworks, and languages
              based on your team&apos;s expertise, time-to-market constraints, and long-term
              maintainability.
            </p>
            <ul className="space-y-3 text-slate-600 dark:text-slate-400 mb-8">
              <li className="flex items-start gap-3">
                <CheckCircle2 size={20} className="text-orange-500 flex-shrink-0 mt-0.5" />{" "}
                <span>Unbiased framework comparisons</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={20} className="text-orange-500 flex-shrink-0 mt-0.5" />{" "}
                <span>Cost-benefit analysis of third-party tools</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={20} className="text-orange-500 flex-shrink-0 mt-0.5" />{" "}
                <span>Risk mitigation for cutting-edge tech</span>
              </li>
            </ul>
            <div className="mt-auto pt-6 border-t border-slate-200 dark:border-white/10">
              <div className="text-sm font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">
          ...
          <GlassCard className="p-8 group hover:-translate-y-1 transition-transform duration-300 flex flex-col h-full">
            ...
            <p className="text-slate-700 dark:text-slate-300 mb-6 flex-grow">
              Is your current application slow, buggy, or hard to update? We conduct deep-dive
              audits into your existing codebase to identify performance bottlenecks and technical
              debt.
            </p>
            <ul className="space-y-3 text-slate-600 dark:text-slate-400 mb-8">
              <li className="flex items-start gap-3">
                <CheckCircle2 size={20} className="text-rose-500 flex-shrink-0 mt-0.5" />{" "}
                <span>Performance and load testing analysis</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={20} className="text-rose-500 flex-shrink-0 mt-0.5" />{" "}
                <span>Security vulnerability identification</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={20} className="text-rose-500 flex-shrink-0 mt-0.5" />{" "}
                <span>Actionable refactoring roadmaps</span>
              </li>
            </ul>
            <div className="mt-auto pt-6 border-t border-slate-200 dark:border-white/10">
              <div className="text-sm font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">
          ...
          <GlassCard className="p-8 group hover:-translate-y-1 transition-transform duration-300 flex flex-col h-full">
            ...
            <p className="text-slate-700 dark:text-slate-300 mb-6 flex-grow">
              We translate complex technical requirements into clear, step-by-step execution plans.
              Know exactly what needs to be built, in what order, and how long it will take.
            </p>
            <ul className="space-y-3 text-slate-600 dark:text-slate-400 mb-8">
              <li className="flex items-start gap-3">
                <CheckCircle2 size={20} className="text-emerald-500 flex-shrink-0 mt-0.5" />{" "}
                <span>Phased delivery planning</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={20} className="text-emerald-500 flex-shrink-0 mt-0.5" />{" "}
                <span>Resource allocation and team structuring</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={20} className="text-emerald-500 flex-shrink-0 mt-0.5" />{" "}
        ...
        <GlassCard className="p-12 text-center relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl font-black mb-6 text-slate-900 dark:text-white">
              Need a clear technical direction?
            </h2>
            <p className="text-lg md:text-xl text-slate-700 dark:text-slate-300 mb-8 max-w-2xl mx-auto">
              Stop letting technical uncertainty slow down your business. Let&apos;s build a roadmap
